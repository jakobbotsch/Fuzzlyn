...
Fuzzlyn has found many thousands of programs producing deviating behavior. Some examples can be seen in the [examples](examples) folder. To take a couple of examples, Fuzzlyn automatically found and produced the following programs:
