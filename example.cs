public class Program
{
    ...
    static void M0()
    {
        byte var0 = (byte)((int)(0UL * (uint)(0 % ((ushort)(((int)(M1(0, 0, (byte)(490360998U - (long)((ulong)(s_113++ - (int)M72()) + (byte)M36())), 0, ref s_117, ref s_9[0], ref s_26, 37, ref s_60, s_47, ref s_78, (byte)M81(), s_77++) + (sbyte)M3((ushort)M18(), ref s_70, (short)(s_108), -2057119971763330565L)) | 1)) | 1))));
    }
